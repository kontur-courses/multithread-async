...
namespace ClusterClient.Clients
{
    public class SmartClusterClient : ClusterClientBase
    {
        ...
        // а вы говорили на паре, что эти алгоритмы оптимизаий не нужны)) вот на основе их я это и реализовал) я про концепт IAsyncEnumerable - а он как раз таки играет важную роль в алгоритмах. а я уже сейчас видя его впервые понимаю, как он раобтает. 
        ...
        // и да я это написываю, чтоб только доказать, что разные по своей природе сущности, могут иметь общий концепт. ибо мне не понравилось, что вы сказали, что это не нужно))
