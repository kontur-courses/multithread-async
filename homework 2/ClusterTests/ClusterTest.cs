...
namespace ClusterTests
{
    ...
    public abstract class ClusterTest
    {
        ...
        protected abstract ClusterClientBase CreateClient(string[] replicaAddresses, IReplicaSendHistory replicaSendHistory);
        ...
        protected TimeSpan[] ProcessRequests(double timeout, int take = 20)
        {
            ...
            var client = CreateClient(addresses, requestHistory);
