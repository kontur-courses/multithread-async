...
public abstract class ClusterTest
{
    ...
    public void SetUp()
    {
        clusterServers = new List<ClusterServer.ClusterServer>();
    }
    ...
    protected ClusterServer.ClusterServer CreateServer(int delay, bool notStart = false, int status = 200)
    {
        ...
        var server = new ClusterServer.ClusterServer(serverOptions, log);
    ...
    private List<ClusterServer.ClusterServer> clusterServers;
