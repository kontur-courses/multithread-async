...
namespace ClusterTests
{
    ...
    {
        protected override ClusterClientBase CreateClient(string[] replicaAddresses, IReplicaSendHistory replicaSendHistory)
            => new RoundRobinClusterClient(replicaAddresses, replicaSendHistory);
